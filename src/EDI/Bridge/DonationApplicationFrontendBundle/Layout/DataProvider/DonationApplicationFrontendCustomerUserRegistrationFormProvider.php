...
namespace EDI\Bridge\DonationApplicationFrontendBundle\Layout\DataProvider;

use Doctrine\Persistence\ManagerRegistry;
use Oro\Bundle\ConfigBundle\Config\ConfigManager;
use Oro\Bundle\CustomerBundle\Entity\CustomerUser;
use Oro\Bundle\CustomerBundle\Entity\CustomerUserRole;
use EDI\Bridge\DonationApplicationFrontendBundle\Form\Type\FrontendCustomerUserRegistrationType;
 ...
 */
class DonationApplicationFrontendCustomerUserRegistrationFormProvider extends AbstractFormProvider
{
//    const ACCOUNT_USER_REGISTER_ROUTE_NAME = 'oro_customer_frontend_customer_user_register';
    const ACCOUNT_USER_REGISTER_ROUTE_NAME = 'edi_donation_application_customer_user_registration';
