...
class DonationApplicationEmbWifePhysCharController extends AbstractController
{
	...
	/**
	 * @Route("/", name="edi_donation_physchar_wife_frontend", options={"frontend"=true})
	 * @Layout
	...
	public function createAction(Request $request, DonationApplicationPagingButtonsHelper $buttonsHelper)
	{
		...
		$emb_physchar = new EmbWifePhysChar();

		return $this->update($emb_physchar, $request, $buttonsHelper);
	}

	/**
	 * Route("/update", name="edi_donation_physchar_wife_frontend", options={"frontend"=true})
	 * Layout
	 * return array|RedirectResponse
	 */
	public function updateAction(EmbWifePhysChar $emb_physchar, Request $request, DonationApplicationPagingButtonsHelper $buttonsHelper)
	{
		return $this->update($emb_physchar, $request, $buttonsHelper);
	}

	private function update(EmbWifePhysChar $emb_physchar, Request $request, DonationApplicationPagingButtonsHelper $buttonsHelper)
	{
		$form = $this->createForm(
			DonationApplicationWifePhysCharType::class,
			$emb_physchar
		);
...
*/
		$returnThis =  ['data' => ['donation_wife_physchar_form' => $form->createView(), 'entity' => $emb_physchar]];
