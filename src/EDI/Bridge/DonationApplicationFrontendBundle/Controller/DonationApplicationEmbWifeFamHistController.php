...
use EDI\Bundle\DonationApplicationBundle\Form\Type\DonationApplicationWifeFamHistType;
...
class DonationApplicationEmbWifeFamHistController extends AbstractController
{
	...
	/**
	 * @Route("/", name="edi_donation_famhist_wife_frontend", options={"frontend"=true})
	 * @Layout
	...
	public function createAction(Request $request, DonationApplicationPagingButtonsHelper $buttonsHelper)
	{
		...
		$emb_famhist = new EmbWifeFamHist();

		return $this->update($emb_famhist, $request, $buttonsHelper);
	}

	/**
	 * Route("/update", name="edi_donation_famhist_wife_frontend", options={"frontend"=true})
	 * Layout
	 * return array|RedirectResponse
	 */
	public function updateAction(EmbWifeFamHist $emb_wife_fam_hist, Request $request, DonationApplicationPagingButtonsHelper $buttonsHelper)
	{
		return $this->update($emb_wife_fam_hist, $request, $buttonsHelper);
	}

	private function update(EmbWifeFamHist $emb_famhist, Request $request, DonationApplicationPagingButtonsHelper $buttonsHelper)
	{
		$form = $this->createForm(
			DonationApplicationWifeFamHistType::class,
			$emb_famhist
		);
...
*/
		$returnThis =  ['data' => ['donation_wife_famhist_form' => $form->createView(), 'entity' => $emb_famhist]];
