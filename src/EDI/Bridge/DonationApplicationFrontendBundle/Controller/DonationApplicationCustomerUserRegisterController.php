 ...
 */
class DonationApplicationCustomerUserRegisterController extends AbstractController
{
    /**
     * Create customer user form
     *
     * @Route("/registration", name="edi_donation_application_customer_user_registration")
     * @Layout()
    ...
    protected function handleForm(Request $request)
    {
        ...
        $registrationHandler = $this->get('edi_frontend.handler.donation_application_customer_registration_handler');
        // Added to original code by JDA on 2022-06-20 to remove
        $customerUserForm = $registrationHandler->getForm();
        $customerUserForm->remove('companyName');
