...
class DonationApplicationWifePhysCharType extends AbstractType
{
	...
	public function configureOptions(OptionsResolver $resolver)
	{
		$resolver->setDefaults(array(
			'data_class' => 'EDI\Bundle\DonationApplicationBundle\Entity\EmbWifePhysChar',
		));
	}

	public function getName()
	{
		return 'donation_application_wife_phys_char';
	}
}