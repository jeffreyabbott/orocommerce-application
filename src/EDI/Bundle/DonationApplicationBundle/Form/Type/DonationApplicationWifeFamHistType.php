...
class DonationApplicationWifeFamHistType extends AbstractType
{
	...
	public function configureOptions(OptionsResolver $resolver)
	{
		$resolver->setDefaults(array(
			'data_class' => 'EDI\Bundle\DonationApplicationBundle\Entity\EmbWifeFamHist',
		));
	}

	public function getName()
	{
		return 'donation_application_wife_fam_hist';
	}
}