...
class DonationApplicationWifeSocialHistoryType extends AbstractType
{
	...
	public function configureOptions(OptionsResolver $resolver)
	{
		$resolver->setDefaults(array(
			'data_class' => 'EDI\Bundle\DonationApplicationBundle\Entity\EmbWifeSocialHistory',
		));
	}

	public function getName()
	{
		return 'donation_application_wife_social_history';
	}
}